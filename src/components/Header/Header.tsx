        ...
        >
          <ul className="flex w-full justify-center flex-row items-center  lg:flex-row lg:justify-center lg:space-y-0 ">
            <li className="lg:mr-8 mr-6">
              ...
              >
                <Github className="bg-slate-800 rounded-full h-10 w-10 p-2" />
              </Link>
            </li>
            <li className="lg:mr-8 mr-6">
              <Link
              ...
              >
                <Linkedin className="bg-slate-800 rounded-full h-10 w-10 p-2" />
              </Link>
            </li>
            <li className="lg:mr-8">
              <Link
              ...
              >
                <Mail className="bg-slate-800 rounded-full h-10 w-10 p-2" />
              </Link>
            </li>
          </ul>
        </nav>
